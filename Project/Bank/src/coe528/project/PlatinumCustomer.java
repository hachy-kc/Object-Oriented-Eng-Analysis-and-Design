...
public class PlatinumCustomer extends Customer {
    ...
    */
    ...
    public boolean purchase(int amount) {
        ...
        platinum customers have no fee upon purchase
        */
