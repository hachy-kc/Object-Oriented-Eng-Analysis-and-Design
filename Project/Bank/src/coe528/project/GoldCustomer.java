...
public class GoldCustomer extends Customer {
    ...
    */
    ...
    public boolean purchase(int amount) {
        ...
        since the customer is gold they have a $10 order fee
        */
